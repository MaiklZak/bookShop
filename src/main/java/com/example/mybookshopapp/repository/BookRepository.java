...
public interface BookRepository extends JpaRepository<Book, Integer> {
    ...
    @Query(value = "SELECT * FROM books INNER JOIN (SELECT b.id book_id, ROUND(AVG(br.value)) rating FROM books b INNER JOIN book_rating br ON b.id = br.book_id " +
    ...
    @Query(value = "SELECT * FROM books INNER JOIN " +
